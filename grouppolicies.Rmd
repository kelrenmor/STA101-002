...
- Designate a coordinator, recorder, and monitor, checker, reviewer for each assignment. These should vary so that each group member takes a different role on a new assignment. For smaller teams, members may need to take on multiple roles.
