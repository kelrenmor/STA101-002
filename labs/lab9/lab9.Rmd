...
5. [**On your own**] Pick one of the other 17 remaining explanatory variables that you think is most likely to predict an email's spam status and fit a `glm` model using it. Describe how this explanatory variable affects the probability of an email being spam generally, and calculating the probability that the message is spam for two values of your explanatory variable (e.g., in the previous problem we calculated the probability for emails that were and were not sent to multiple recipients).
