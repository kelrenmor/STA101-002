...
Let's load the tidyverse package and the data.
...
download.file("https://kelrenmor.github.io/STA101-002/labs/lab3/sta101_lab3.Rmd", destfile = "sta101_lab3.Rmd")
```
...
His performance against the Orlando Magic in the [2009 NBA Finals](https://en.wikipedia.org/wiki/2009_NBA_Finals) earned him the title *Most Valuable Player* and many spectators commented on how he appeared to show a hot hand. The data file we'll use is called `kobe`.
...
```{r calc-streak-kobe}
# First, source the code from where we define the function
source("https://kelrenmor.github.io/STA101-002/labs/functions/calc_streak.R") 
# Then use the function to calculate the Kobe streak
kobe_streak <- calc_streak(kobe$shot)
```
