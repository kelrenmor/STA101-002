...
Lab 1 will be turned in as a team -- only one person needs to submit the assignment on Sakai. Everyone will submit their post-lab teammate evaluation individually on Sakai, if desired. If you do not submit a post-lab teammate evaluation, it will be assumed that you feel everyone contributed fairly.

As the labs progress, you are encouraged to explore beyond what the labs dictate; a willingness to experiment will make you a much better programmer.  Before we get to that stage, however, you need to build some basic fluency in R. Today we begin with the fundamental building blocks of R and RStudio: the interface, reading in data, and basic commands.

![Recall the Rstudio interface, shown above.](rstudio.png)
...
download.file("https://kelrenmor.github.io/STA101-002/labs/lab1/sta101_lab1.Rmd", destfile="sta101_lab1.Rmd")
```
