...
* [Project reflections](https://kelrenmor.github.io/STA101-002/project_files/project_st3_statement) (due Tuesday, June 23): 1/10 of overall project grade
...
Your Stage 3 Project Reflection should be written using the [provided Word template](https://kelrenmor.github.io/STA101-002/project_files/sta101_prj_reflection.docx). There is no length requirement. The positive/constructive feeback component should be shared via the Duke Box file associated with each presenter (see links above).
